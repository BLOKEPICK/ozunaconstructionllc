      ...
      <div className="mx-auto max-w-7xl px-4 py-24 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-6 text-sm text-slate-300">
            ...
            <a href={`mailto:${COMPANY.email}`} className="inline-flex items-center gap-2 underline decoration-white/40 underline-offset-4"><Mail className="w-5 h-5" /> {COMPANY.email}</a></div></div>
