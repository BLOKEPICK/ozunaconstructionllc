...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      <div className="absolute inset-0 pointer-events-none opacity-10" style={{backgroundImage: "radial-gradient(#10b981 1px, transparent 1px)", backgroundSize: "16px 16px"}}/>
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-24 grid lg:grid-cols-2 gap-10 items-center">
        <div>
        ...
        <div className="relative">
          <div className="aspect-[4/3] relative w-full rounded-2xl bg-white/5 ring-1 ring-white/10 grid place-items-center text-center p-6">
            <Image src="/hero.webp" alt="Modern home exterior with architectural shingles and dark siding in Columbus, OH" fill priority sizes="(min-width: 1024px) 640px, 100vw" className="object-cover" />
          </div></div></div></section>
  );
}