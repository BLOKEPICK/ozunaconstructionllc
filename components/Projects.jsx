      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-slate-600">Galería con fotos seleccionadas del Instagram del cliente. En producción usaré versiones .webp optimizadas y alt text SEO.</p></div>
          <a className="text-emerald-700 font-semibold" href={COMPANY.instagram} target="_blank">Ver Instagram →</a></div>
              ...
              <div className="aspect-square w-full rounded-2xl overflow-hidden bg-slate-100 border border-slate-200 grid place-items-center">
                {p.img ? (
                  ...
                  <div className="text-center p-6 text-slate-500">
                    ...
                    <p className="mt-3 text-xs">(Imagen de ejemplo — sustituir por foto real)</p></div>
                )}
              </div></a>
          ))}
        </div></div></section>
