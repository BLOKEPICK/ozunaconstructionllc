      ...
      <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
        <a href="#top" className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            ...
            <p className="text-xs text-slate-500">{COMPANY.city}</p></div></a>
        <nav className="hidden md:flex items-center gap-6 text-sm text-slate-700">
          ...
          <a href="#contact" className="hover:text-emerald-700">Contacto</a></nav>
        <div className="flex items-center gap-2">
          ...
          <a href={COMPANY.phoneHref} className="inline-flex items-center gap-2 rounded-xl px-3 py-2 bg-slate-900 text-white text-sm font-semibold shadow hover:bg-slate-800" aria-label="Call Now">
            <Phone className="w-5 h-5" /> <span>{COMPANY.phone}</span></a></div></div></header>
  );
}