    ...
    <main className="min-h-screen bg-white text-slate-900">
      <section className="py-20 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <p className="mt-3 text-slate-200">Expert {content.title.toLowerCase()} in Columbus, OH</p></div></section>
      ...
      <section className="py-16 bg-slate-50">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <a href="/contact" className="rounded-xl bg-emerald-600 text-white font-semibold px-6 py-3">Contact Us</a></div></section></main>
  );
}
